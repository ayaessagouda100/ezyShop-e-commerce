...
const paymentSchema = z.object({
  ...
  phone: z.string().regex(/^01[0-2,5]\d{8}$/, "Enter a valid Egyptian phone number"),
...
export default function CheckoutSession() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-2xl p-6 sm:p-8 md:p-10">
        <h1 className="text-center font-bold text-2xl sm:text-3xl md:text-4xl text-slate-600 mb-6">
          Checkout Payment
        </h1>
        <Form {...paymentForm}>
          <form onSubmit={paymentForm.handleSubmit(handleCreditPayment)} className="space-y-4">
            <FormField
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4 mt-7">
              <Button
                type="button"
                className="w-full sm:w-1/2 bg-yellow-400 cursor-pointer"
